...
def create_app(config_class=DevelopmentConfig):
    ...
    from app.blueprints.analise import analise_bp # Importando o blueprint análise
    app.register_blueprint(analise_bp) # Registrando o blueprint análise com prefixo de URL
